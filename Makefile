.PHONY: migrate migrate_down migrate_up migrate_version compose_debug compose_hot__reload compose_prod compose_dev_db compose_dlv_reload check_install, swagger
